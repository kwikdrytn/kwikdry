...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2 border-secondary", className)} {...props} />;
});
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="footer" className={cn("flex flex-col gap-2 p-2 border-secondary", className)} {...props} />;
});
